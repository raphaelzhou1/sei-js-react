...
function decodeHeader(data) {
    return {
        ...
        height: (0, inthelpers_1.apiToSmallInt)((0, encodings_1.assertNotEmpty)(data.height)),
        time: (0, tendermint_rpc_1.fromRfc3339WithNanoseconds)((0, encodings_1.assertNotEmpty)(data.time)),
...
function decodeBlockIdFlag(blockIdFlag) {
    (0, utils_1.assert)(blockIdFlag in tendermint_rpc_1.BlockIdFlag);
    return blockIdFlag;
}
/**
...
function decodeOptionalTime(timestamp) {
    ...
    return nonZeroTime ? (0, tendermint_rpc_1.fromRfc3339WithNanoseconds)(timestamp) : undefined;
}
function decodeCommitSignature(data) {
    return {
        blockIdFlag: decodeBlockIdFlag(data.block_id_flag),
        validatorAddress: data.validator_address
            ? (0, encoding_1.fromHex)(data.validator_address)
            : undefined,
...
function decodeGenesis(data) {
    return {
        genesisTime: (0, tendermint_rpc_1.fromRfc3339WithNanoseconds)((0, encodings_1.assertNotEmpty)(data.genesis_time)),
        chainId: (0, encodings_1.assertNotEmpty)(data.chain_id),
        consensusParams: decodeConsensusParams(data.consensus_params),
        validators: data.validators
            ? (0, encodings_1.assertArray)(data.validators).map(decodeValidatorGenesis)
            : [],
        appHash: (0, encoding_1.fromHex)((0, encodings_1.assertSet)(data.app_hash)),
...
function decodeValidatorInfo(data) {
    return {
        pubkey: data.pub_key && decodePubkey((0, encodings_1.assertObject)(data.pub_key)),
        votingPower: (0, inthelpers_1.apiToBigInt)((0, encodings_1.assertNotEmpty)(data.voting_power)),
        address: data.address
            ? (0, encoding_1.fromHex)((0, encodings_1.assertNotEmpty)(data.address))
            : new Uint8Array(),
...
function decodeSyncInfo(data) {
    return {
        ...
        latestBlockTime: (0, tendermint_rpc_1.fromRfc3339WithNanoseconds)((0, encodings_1.assertNotEmpty)(data.latest_block_time)),
...
function decodeBlock(data) {
    ...
    return {
        ...
        lastCommit: data.last_commit.block_id.hash
            ? decodeCommit((0, encodings_1.assertObject)(data.last_commit))
            : null,
