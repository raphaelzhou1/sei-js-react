...
const useSigningCosmWasmClient = (customRpcUrl) => {
        ...
        const getClient = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                if (!rpcUrl || !offlineSigner || !chainId)
                    return;
                setIsLoading(true);
                const client = yield (0, core_1.getSigningCosmWasmClient)(customRpcUrl || rpcUrl, offlineSigner, {
...
exports.default = useSigningCosmWasmClient;
